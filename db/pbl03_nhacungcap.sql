...
CREATE TABLE `nhacungcap` (
  ...
  `NguoiDaiDien` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `LinhVucKinhDoanh` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
