...
function NhanVienShow() {
  fetch('http://localhost:8089/taikhoan/employee')
    .then(res => res.json())
    .then(data => {
      console.log(data);
      ...
      data.forEach(user => {
        ...
        $("#productTable tbody").append("<tr>" +
          "<td>" +
          `<button type='button' onclick='window.location.href="QLNV_Update.html?id=${user.employee.maNV}";' class='btn btn-default'>` +
